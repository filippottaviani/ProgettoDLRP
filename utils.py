...
def plot_metrics(self):
    ...
    plt.plot(self.glb_train_loss, label="L1 Loss")
    plt.xlabel("Epoche")
    plt.ylabel("Loss")
    plt.title("Andamento della loss L1 durante l'addestramento della Global Net")
    plt.grid(True)
    plt.show(block=False)
    plt.pause(20)
    plt.savefig('gl_train_loss.png')
    plt.close()

    plt.plot(self.pre_train_loss, label="L1 Loss")
    plt.xlabel("Epoche")
    plt.ylabel("Loss")
    plt.title("Andamento della loss L1 durante il pre-addestramento della Refinement Net")
    plt.grid(True)
    plt.show(block=False)
    plt.pause(20)
    plt.savefig('ref_pretrain_loss.png')
    plt.close()

    plt.plot(self.adv_r_train_loss, label="Refinement Loss")
    plt.xlabel("Epoche")
    plt.ylabel("Loss")
    plt.title("Andamento della loss composita durante l'addestramento avversario")
    plt.grid(True)
    plt.show(block=False)
    plt.pause(20)
    plt.savefig('adv_r_train_loss.png')
    plt.close()

    plt.plot(self.adv_d_train_loss, label="Discriminator Loss")
    plt.xlabel("Epoche")
    plt.ylabel("Loss")
    plt.title("Andamento della loss BCE durante l'addestramento avversario")
    plt.grid(True)
    plt.show(block=False)
    plt.pause(20)
    plt.savefig('adv_d_train_loss.png')
    plt.close()
